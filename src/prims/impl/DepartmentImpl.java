 ...
 * </p>
 * <ul>
 *   <li>{@link prims.impl.DepartmentImpl#getName <em>Name</em>}</li>
 *   <li>{@link prims.impl.DepartmentImpl#getPermission <em>Permission</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DepartmentImpl extends MinimalEObjectImpl.Container implements Department {
	...
	protected EClass eStaticClass() {
		return PrimsPackage.Literals.DEPARTMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimsPackage.DEPARTMENT__NAME, oldName, name));
	}
	...
	public void setPermission(String newPermission) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PrimsPackage.DEPARTMENT__PERMISSION, oldPermission, permission));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PrimsPackage.DEPARTMENT__NAME:
				return getName();
			case PrimsPackage.DEPARTMENT__PERMISSION:
